...
class ThirdViewController: UIViewController, IGLDropDownMenuDelegate {
        ...
        var dataTitle: NSArray = ["rain", "sun", "cloud", "fog"]
        ...
        func setupInIt() {
            ...
            dropDownMenuFolder.frame = CGRect(x: 17, y: 45, width: 200, height: 45)
            ...
            myLabel.frame = CGRect(x: 17, y: 45, width: 200, height: 45)
